...
cancer <- cancer.raw %>% 
  ...
  mutate(Procedure = case_when(
    ...
    Procedure_Unk_OFF = case_when(
      ...
      Chemotherapy == "Yes" & Radiotherapy == "Yes" ~ "Chemotherapy and Radiotherapy",
      TRUE ~ "Other"),
    Procedure_Unk_OFF = factor(Procedure_Unk_OFF, levels = c("Surgery Only", "Chemotherapy Only", "Radiotherapy Only", "Chemotherapy and Radiotherapy", "Other")),
...
suppressWarnings(tryCatch({
  write.csv(cancer, "~/Library/CloudStorage/Box-Box/Sanchez-Diaz Lab/CVD and BC/Registro Central de Cancer/Data/cancer_cleansed.csv")
}, error = function(e) {

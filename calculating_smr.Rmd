...
smr_global <- table_c_2 %>%
  ...
  mutate(rate_per_100py = total_deaths/ total_person_time * 1000) %>%
  summarise(
    SMR = rate_per_100py[type_of_death == "Observed"] / rate_per_100py[type_of_death == "Expected"],
...
smr_result <- sir(coh.data = table_a_2, coh.obs = 'bc_cvd_deaths', 
                  coh.pyrs = 'bc_personyears', ref.data = gen_2, 
                  ref.rate = 'gen_cvd_rate', adjust = c('AgeDeathCat2', 'current_data_year')); smr_result

...
smrs_by_year <- table_c_2 %>%
  group_by(year) %>%
  summarise(
    SMR = rate_per_100py[type_of_death == "Observed"] / rate_per_100py[type_of_death == "Expected"]); smrs_by_year
...
smr_global <- table_c_2 %>%
  ...
  summarise(
    SMR = rate_per_100py[type_of_death == "Observed"] / rate_per_100py[type_of_death == "Expected"]); smr_global

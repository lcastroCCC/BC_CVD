...
# US Age Groups
us_smr_dx_agegroup <- read.delim("~/Downloads/Statistical Analysis/Inputs/smr_dx_agegroup.txt") %>%
...
us_sir_general_cl_df <- read.delim2("~/Downloads/Statistical Analysis/Scripts/sir_general_case_listing.txt") %>%

...
head(sort(table(mort$icd_code_10_th_revision), decreasing = TRUE), 5)
```
...
table(cvd_deaths_no_BC$`1_st_condition`) # Confirming which ICD 10 codes show up
...
table(cvdtest$`1_st_condition`) # Confirming which ICD 10 codes show up

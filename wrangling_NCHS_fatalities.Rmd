...
}, error = function(e) {}, error = function(e) {}, error = function(e) {
...
grouped_cvd_deaths_gen2 <- cvd_deaths_no_BC %>% group_by(current_data_year, AgeDeathCat2) %>% count(); grouped_cvd_deaths_gen2
clean_n_cvd_deaths_gen2 <- left_join(grouped_cvd_deaths_gen2, cvm_by_year_agegroup2[, c("Year", "AgeGroup2", "cvd_deaths_BC")], 
          join_by("current_data_year" == "Year",
